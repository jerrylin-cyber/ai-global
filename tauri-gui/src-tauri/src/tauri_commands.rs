...
pub fn get_command_info(action: String) -> Result<String, String> {
    ...
    let allowed_action = match action.as_str() {
        ...
        "list-skills" => crate::command_safety::AllowedAction::ListSkills,
        "list-rules" => crate::command_safety::AllowedAction::ListRules,
        "list-commands" => crate::command_safety::AllowedAction::ListCommands,
        "list-agents" => crate::command_safety::AllowedAction::ListAgents,
