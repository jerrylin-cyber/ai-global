...
impl AllowedAction {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            AllowedAction::ListSkills => "list-skills",
            AllowedAction::ListRules => "list-rules",
            AllowedAction::ListCommands => "list-commands",
            AllowedAction::ListAgents => "list-agents",
    ...
    pub fn from_str(s: &str) -> Result<Self, String> {
        match s {
            ...
            "list-skills" => Ok(AllowedAction::ListSkills),
            "list-rules" => Ok(AllowedAction::ListRules),
            "list-commands" => Ok(AllowedAction::ListCommands),
            "list-agents" => Ok(AllowedAction::ListAgents),
